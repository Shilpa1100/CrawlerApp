    ...
    <div class="container mt-5 mb-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label for="name">Company Name<sup class="required">  * </sup></label>
                    <input type="text" class="form-control" id="name" v-model="clientDetails.name">
                </div>
                <div class="mb-3">
                    <label for="name">Status<sup class="required"> * </sup></label>
                    <input type="text" class="form-control" id="status" v-model="clientDetails.status">
                </div>
                <div class="mb-3">
                    <label for="name">CIN<sup class="required"> * </sup></label>
                ...
                <div class="mb-3">
                    <label for="name">PIN<sup class="required"> * </sup></label>
                    <input type="text" class="form-control" id="pin" v-model="clientDetails.pin">
                </div>
                <div class="mb-3">
                    <label for="name">Email<sup class="required"> * </sup></label>
